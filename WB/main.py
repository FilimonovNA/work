...
def get_content(shard, query, req, low_price=1, top_price=200000):
    ...
    for page in range(1, 100):
        ...
        url = f'https://catalog.wb.ru/catalog/{shard}/catalog?appType=1&curr=rub&dest=-1075831,-77677,-398551,12358499&locale=ru&page={page}&search={req}&priceU={low_price * 100};{top_price * 100}&reg=0&regions=64,83,4,38,80,33,70,82,86,30,69,1,48,22,66,31,40&sort=popular&spp=0&{query}'
...
def parser(url, req, low_price, top_price):
    ...
    try:
        ...
        req = req.replace(" ", "+")
        data_list = get_content(shard=shard, query=query, req=req, low_price=low_price, top_price=top_price)
...
if __name__ == '__main__':
    ...
    url = 'https://www.wildberries.ru/catalog/aksessuary/sumki-i-ryukzaki/sumki'
    low_price = 2000
    top_price = 2400
    req = input("Введите запрос: ")
    parser(url, req, low_price, top_price)
